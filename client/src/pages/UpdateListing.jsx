...
export default function CreateListing() {
    ...
    return (
        <main className='p-3 max-w-4xl mx-auto'>
            <h1 className='text-3xl font-semibold text-center my-7'>Actualizar salón</h1>
            <form onSubmit={handleSubmit} className='flex flex-col sm:flex-row gap-4'>
                <div className='flex flex-col gap-4 flex-1'>
                    <input type="text" placeholder='Nombre del Salón' className='border p-3 rounded-lg' id='name' maxLength='62' minLength='10' required onChange={handleChange} value={formData.name} />
                    <textarea type="text" placeholder='Descripción' className='border p-3 rounded-lg' id='description' required onChange={handleChange} value={formData.description} />
            ...
            {formData.offer && (<div className='flex items-center gap-2'>
              ...
              <div className='flex flex-col items-center'>
                ...
                <div className='flex flex-col flex-1 gap-4'>
                    ...
                    <button disabled={loading || uploading} className='p-3 bg-blue-900 text-white rounded-lg uppercase hover:opacity-80 disabled:opacity-50'>{loading ? 'Creando...' : 'Actualizar salón'}</button>
